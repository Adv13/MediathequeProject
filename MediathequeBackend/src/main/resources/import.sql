...
insert into item (titre, nombre_Exemplaires, date_Parution) values ('Cantorix, le forgeron des dieux', 126, '2022-06-14');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('Tolkien, l’Europe et la tradition', 390, '2022-07-24');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('La Bête de Grésivaudan', 264, '2016-08-30');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('La Tribu de Dana', 100, '1998-06-07');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('Les lacs du connemara', 161, '1981-03-17');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('Etoile des neiges', 359, '1949-12-24');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('Les Douze Travaux de Astérix', 359, '1976-04-20');
insert into item (titre, nombre_Exemplaires, date_Parution) values ('La Cité de la peur', 200, '1994-03-17');
...
insert into emprunt (date_emprunt, date_retour, user_id) values ('2022-10-13', '2022-10-21', 1);
